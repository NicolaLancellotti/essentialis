...
final class MinBinaryHeapTests: XCTestCase {
...
extension MinBinaryHeapTests {

  func makeHeapWithInit() -> MinBinaryHeap<Int, String> {
  ...
  func makeHeapWithInsert() -> MinBinaryHeap<Int, String> {
    var heap = MinBinaryHeap<Int, String>()
  ...
  func makeHeapWithMerge() -> MinBinaryHeap<Int, String> {
    var heap: MinBinaryHeap = [
      (key: 5, elem: "e"),
      (key: 2, elem: "b"),
    ]

    let heap2: MinBinaryHeap = [
      (key: 4, elem: "d"),
      (key: 3, elem: "c"),
    ]
  ...
  func sharedTest(heap: inout MinBinaryHeap<Int, String>) {
